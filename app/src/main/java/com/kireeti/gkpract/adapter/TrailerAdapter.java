...
public class TrailerAdapter extends BaseAdapter implements Filterable {
    ...
    private Receiving_Photo_UploadActivity callbacks;

    public TrailerAdapter(Context mContext, List<TrailerFolios> details) {
    ...
    public void setCallBack(Receiving_Photo_UploadActivity activity){
