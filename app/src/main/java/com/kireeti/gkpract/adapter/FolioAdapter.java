...
public class FolioAdapter extends BaseAdapter implements Filterable {
    ...
    public FolioAdapter(Context mContext, List<TrailerFolios> details) {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (details != null && constraint != null) {
                for (int i = 0; i < details.size(); i++) {
                    if (details.get(i).getTrailerFolio().toLowerCase().contains(constraint)) {
    ...
    public void setCallBack(NotThereActivity activity){
