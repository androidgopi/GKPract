...
public class ReceivingImageAdapter extends RecyclerView.Adapter<ReceivingImageAdapter.ViewHolder> {
    Context mContext;
    ...
    public ReceivingImageAdapter(Context mContext, List<ImageFile> notesList, boolean fromResponse) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ReceivingImageAdapter parent;
        ImageView adapter_image, remove_photo;
        TextView file_name;
        TextView file_comment;

        public ViewHolder(View view, ReceivingImageAdapter parent) {
            super(view);
            this.parent = parent;
